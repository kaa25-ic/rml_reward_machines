"""Train Double DQN on randomized LetterEnv."""
...
DEFAULT_MONITOR_CONFIG = RANDOMIZED_ENV_ROOT / "configs" / "random_letter_en.yaml"
DEFAULT_MONITOR_SPEC = RANDOMIZED_ENV_ROOT / "specs" / "letter_env_monitor.pl"


@dataclass(frozen=True)
class RandomizedLetterEnvDDQNTrainingConfig:
    """Training configuration for one randomized LetterEnv DDQN run."""
...
def train_randomized_letter_env_ddqn(
    config: RandomizedLetterEnvDDQNTrainingConfig,
    *,
    ...
    """Train one randomized LetterEnv DDQN run and write its artifacts."""
...
def _write_run_config(
    ...
    *,
    ...
    payload = {
        "experiment": "randomized_letter_env_ddqn",
...
def main() -> None:
    ...
    summary = train_randomized_letter_env_ddqn(
        config,
        policy_config=policy_config,
