"""Train the basic LetterEnv GNN monitor encoder from monitor transitions."""
...
from envs.letter_env.gnn_pretraining import GNNDynamicsConfig, train_gnn_dynamics
